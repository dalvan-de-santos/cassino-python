...
def test_resultado_tres_sete_iguais():
    pontos = 0
...
def test_resultado_tres_iguais_():
    pontos = 0
...
def test_resultado_primeiro_segundo_iguais():
    pontos = 0
...
def test_resultado_primeiro_ultimo_iguais():
    pontos = 0
...
def test_resultado_segundo_ultimo_iguais():
    pontos = 0
